 ...
 * It renders mood cards with emoji, reason, and timestamp, and handles empty states.
 * Each mood card is clickable to navigate to the edit page.
 */
 ...
 *   ]}
 *   onSelectMood={(id) => router.push(`/edit-mood/${id}`)}
 * />
 */
